...
public class Home extends LoadPage {
    ...
    public boolean verifycarousel() {
        return Events.isVisibleWebElement(carousel);
    }


    @FindBy(id = "buttonCarousel")
    private WebElement buttonCarousel;

    public boolean verifybuttonCarousel() {
    ...
    public AboutUs clickbuttonFooterAboutus(){
        Events.click(buttonFooterAboutus);
        return new AboutUs();
    }
    ...
    public Activities clickbuttonFooterActivities(){
        Events.click(buttonFooterActivities);
        return new Activities();
    }
    ...
    public  ContactUs clickbuttonFooterContact(){
        Events.click(buttonFooterContact);
        return new ContactUs();
    }
    ...
    public boolean verifycheckboxCardActivities() throws InterruptedException {
        Thread.sleep(5000);
    ...
    public boolean verifylabelWarncardWarning(){
        WebDriverWait wait = new WebDriverWait(Manager.getInstance().getWebDriver(), 20);
        wait.until(ExpectedConditions.visibilityOf(labelWarncardWarning));
        return Events.isVisibleWebElement(labelWarncardWarning);}
