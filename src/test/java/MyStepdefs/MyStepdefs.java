...
public class MyStepdefs {
    ...
    public void verifyExistenceOfActivitiesCheckbox() throws InterruptedException {
    ...
    @And("^Verify if Send button is enabled$")
    public void verifyIfSendButtonIsEnabled() {
    ...
    public void verifyExistenceOfCarouselOnHomePage() {
        Assert.assertTrue(home.verifycarousel());
    }

    @And("^Verify existence of Contact Us button on carousel on home$")
    public void verifyExistenceOfContactUsButtonOnCarouselOnHome() {
        Assert.assertTrue(home.verifybuttonCarousel());
    }

    @And("^Click Contact Us button on carousel$")
    public void clickContactUsButtonOnCarousel() {
        home.clickbuttonCarousel();
    }

    @Then("^Click ContactUs button on parallax on about us$")
    public void clickContactUsButtonOnParallaxOnAboutUs() {
        aboutus.clickbuttonAboutusContact();
    }

    @Then("^Click GDG Cochabamba button$")
    public void clickGDGCochabambaButton() {
        Assert.assertTrue(aboutus.clickimageCommunity0());
    }

    @Then("^Click Technovation button$")
    public void clickTechnovationButton() {
        Assert.assertTrue(aboutus.clickimageCommunity1());
    }


    @Then("^Click GP(\\d+)Tech button$")
    public void clickGPTechButton(int arg0) {
        Assert.assertTrue(aboutus.clickimageCommunity2());
    }

    @Then("^Click Girls Hack button$")
    public void clickGirlsHackButton() {
        Assert.assertTrue(aboutus.clickimageCommunity3());
    }


    @Then("^Click Pyladies button$")
    public void clickPyladiesButton() {
        Assert.assertTrue(aboutus.clickimageCommunity4());
    }

    @Then("^Click Women Tech Markers Cochabamba  button$")
    public void clickWomenTechMarkersCochabambaButton() {
        Assert.assertTrue(aboutus.clickimageCommunity5());
    }

    @Then("^Click Our Team button on footer$")
    public void clickOurTeamButtonOnFooter() {
        aboutus= home.clickbuttonFooterAboutus();
    }

    @Then("^Click Activities button on footer$")
    public void clickActivitiesButtonOnFooter() {
        activities = home.clickbuttonFooterActivities();
    }

    @Then("^Click Contact Us button on footer$")
    public void clickContactUsButtonOnFooter() {
        contactus= home.clickbuttonFooterContact();
    }
}
